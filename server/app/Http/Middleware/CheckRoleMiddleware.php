...
//        $role_id = Auth::User()->role_id;
        ...
        switch ($role->code) {
            case 'admin':
                $arrayUrl = ['departments','regions','messagetemplates','activities','logssentmessagetemplates','leadsprocesses','users','leads','products','productcategories','tipsters','gifts','giftcategories','messages', 'assignments'];
                break;
            case 'community':
            ...
            case 'service':
                ...
                break;
            case 'ambassador':
                $arrayUrl = ['activities','tipsters','leads','products','productcategories','gifts','messages', 'users'];
                break;
            case 'tipster_normal':
                $arrayUrl = ['activities','tipsters','leads','products','productcategories','gifts','messages', 'users'];
                break;
        ...
        if(strpos($uri, 'common/error') !== false){
                return $next($request);
        }
