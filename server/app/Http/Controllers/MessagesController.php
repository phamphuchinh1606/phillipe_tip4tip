...
//        return view('messages.edit', compact('message', 'id'));
    ...
    public function destroy($id)
    {
        ...
        $message->delete_is = 1;
        $message->save();
        return redirect()->route('messages.index')->with('success', 'Your message removed to the trash.');
    }
    ...
    public function deleteMessageSent($id)
    {
        ...
        $message->save();
        return redirect()->route('messages.index')->with('success', 'Your message was removed successfully.');
    }

    public function deleteMessageSentAll(Request $request)
    {
        $list_id = $request->list_id;
        if(!is_null($list_id) && !empty($list_id) ){
            $arrayId = explode(",",$list_id);
            ...
            return redirect()->route('messages.sent')->with('success', 'Your message was removed successfully.');
        }
    }
    ...
    public function deleteMessageTrashAll(Request $request)
    {
        $list_id = $request->list_id;
        if(!is_null($list_id) && !empty($list_id) ){
            $arrayId = explode(",",$list_id);
            ...
            return redirect()->route('messages.trash')->with('success', 'Your message was removed successfully.');
        }
    }
