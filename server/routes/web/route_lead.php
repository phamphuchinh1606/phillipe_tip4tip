...
Route::get('/leads/deleted/{id}/show', 'LeadsController@deleteShow')->name('leads.deleteShow');
Route::get('/leads/deleted', 'LeadsController@deletedList')->name('leads.deleteList');
...
Route::post('/leads/delete/restore/{id}', 'LeadsController@restore')->name('leads.restore');
