...
@section('javascript')
    ...
    <script>
      ...
      $(document).ready(function(){
          ...
          $('#frmAction').on('change',function(){
              $value = $(this).val();
              $inputPlus = $('#frmActionType input[value=plus]');
              $inputMinus = $('#frmActionType input[value=minus]');
              switch ($value) {
                  case 'Init':
                      $inputPlus.prop('checked', true);
                      break;
                  case 'Bonus':
                      $inputPlus.prop('checked', true);
                      break;
                  case 'Buy Gift':
                      $inputMinus.prop('checked', true);
                      break;
              }
          });
      })
...
@section('body.breadcrumbs')
    {{ Breadcrumbs::render('tipsters.edit') }}
@stop
@section('content')
    @if($editAction == false)
            ...
            <div class="box box-warning">
                ...
                <form role="form" method="post" action="{{route('tipsters.update', $user->id)}}" enctype = "multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row @if(!$isAdmin) hidden @endif">
                            <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    <label>Password</label>
                                    <input name="password" type="password" value="{{$user->password}}" class="form-control" placeholder="Enter ..." required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <input name="password_confirmation" value="{{$user->password}}" type="password" class="form-control" placeholder="Enter ..." required>
                                    @if ($errors->has('password'))
                                        <span class="help-block">
                                        <strong>{{ $errors->first('password') }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="date" name="birthday" value="{{$user->birthday}}"
                        ...
                        <form method="get" class="form-horizontal form-horizontal-custom" action="{{route('tipsters.updatePointManual', $user->id)}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="control-input">
                                    <input id="frmTipster" type="text" readonly class="form-control" placeholder="{{$user->fullname}} ({{$user->email}})">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div id="frmActionType" class="control-input control-inline">
                                    ...
                                    <input name="pointsUpdate" type="number" class="form-control" required autofocus style="width: 100px;" min="0">
                                    <label>Points</label>
                                </div>
                            </div>
                            <div class="form-group">
