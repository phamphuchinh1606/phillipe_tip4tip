                ...
                <div class="box-body">
                    ...
                    <div class="tab-content" style="padding-top: 20px">
                        <div id="menu1" class="tab-pane fade active in">
                            <span style="display: block" w3-include-html="@include('messagetemplates.emails.example_vn',['body' => $template->content_vn])</span>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                            <span style="display: block" w3-include-html="@include('messagetemplates.emails.example_en',['body' => $template->content_en])</span>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
